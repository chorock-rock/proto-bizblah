...
import './SuggestionWrite.css';

const SuggestionWrite = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="suggestion-write-overlay" onClick={onClose}>
      <div className="suggestion-write-modal" onClick={(e) => e.stopPropagation()}>
